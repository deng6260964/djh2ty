...
class Course(db.Model):
    ...
    course_type = db.Column(
        db.Enum("one_to_one", "one_to_many", name="course_types"), nullable=False
    )
    ...
    teacher = db.relationship(
        "User", backref="taught_courses", foreign_keys=[teacher_id]
    )
...
class CourseEnrollment(db.Model):
    ...
    student = db.relationship(
        "User", backref="enrolled_courses", foreign_keys=[student_id]
    )
