...
class ConfigManager:
    ...
    def get_database_config(self) -> Dict[str, str]:
        ...
        if env == "testing":
            return {"uri": "sqlite:///:memory:", "track_modifications": False}
        elif env == "production":
            return {
            ...
            return {
                "uri": self.get_config_value(
                    "DEV_DATABASE_URL", "sqlite:///dev_english_tutoring.db"
                ),
                "track_modifications": False,
            }
    ...
    def get_cors_config(self) -> Dict[str, Any]:
        ...
        """
        origins_str = self.get_config_value(
