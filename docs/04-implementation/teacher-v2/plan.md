...
| Phase | 状态 | 说明 |
| --- | --- | --- |
| Phase 1：主链路闭环 | 已完成 | 已落地工作台、课程周视图、学生账户、收费提醒、预收充值主链路 |
| Phase 2：课程运营能力 | 大部分完成 | 已落地复制上一周课程、调课入口、完成/取消；请假/待补课池尚未做完整闭环 |
| Phase 3：老师端效率增强 | 部分完成 | 已落地作业中心、设置页、收费与账户页重构；反馈/进度仍保留独立页，尚未完全并入学生详情 |
